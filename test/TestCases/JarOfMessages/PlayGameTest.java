...
public class PlayGameTest extends TestBase{
	@Test
    public void TC02() {
		//Pre-condition:
        System.out.println("Pre-condition TC02 - User log into Jar_Of_Messages with valid username and password");
        ...
        //TC02 start:
        System.out.println("Steps TCO2:");
        System.out.println("1: Navigate to Game Page");
        GamePage gamePage = homePage.gotoGamePage();
        
        System.out.println("2: Start a New Game");
        PlayGamePage playGamePage = gamePage.startNewGame();
    }
}
